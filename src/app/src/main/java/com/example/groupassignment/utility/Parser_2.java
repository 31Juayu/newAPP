...
public class Parser_2 implements myParser {
    ...
    public Parser_2(Tokenizer tokenizer,Context context) {
    ...
    public void handleErr(){
        ...
        //case 3:Only 'country' is present, but there are no other elements except '*'
