...
public class Parser_3 implements myParser {

    Tokenizer tokenizer;
    ArrayList<Token> parsedList;
    Context context;
    public Parser_3(Tokenizer tokenizer,Context context) {
    ...
    public void handleErr(){
        ...
        //case 4:Only 'info' is present, but there are no other elements except '*'
